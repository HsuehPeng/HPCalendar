//
//  HPRangeSelectionCalendarView.swift
//  HPCalendar
//
...
public class HPRangeSelectionCalendarView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
	...
	private var viewModel: HPRangeCalendarViewModel {
		didSet {
	...
	init(frame: CGRect, viewModel: HPRangeCalendarViewModel) {
	...
	private func configureCollectionView() {
		...
		collectionView.register(HPRangeSelectionCalendarCell.self, forCellWithReuseIdentifier: HPRangeSelectionCalendarCell.reuseId)
	}
